...
class AccelerometerEvent extends Event {
	...
	public static inline var UPDATE:EventName<AccelerometerEvent> = "update";
	...
	public function new (type:EventName<AccelerometerEvent>, bubbles:Bool = false, cancelable:Bool = false, timestamp:Float = 0, accelerationX:Float = 0, accelerationY:Float = 0, accelerationZ:Float = 0):Void {
