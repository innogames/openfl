	...
	private static function set_cursor(value:MouseCursor):MouseCursor {
		switch (value) {
			...
			case MouseCursor.BUTTON:
				LimeMouse.cursor = POINTER;
			case MouseCursor.HAND:
				LimeMouse.cursor = MOVE;
			case MouseCursor.IBEAM:
				LimeMouse.cursor = TEXT;
			case MouseCursor.__CROSSHAIR:
				LimeMouse.cursor = CROSSHAIR;
			case MouseCursor.__CUSTOM:
				LimeMouse.cursor = CUSTOM;
			case MouseCursor.__RESIZE_NESW:
				LimeMouse.cursor = RESIZE_NESW;
			case MouseCursor.__RESIZE_NS:
				LimeMouse.cursor = RESIZE_NS;
			case MouseCursor.__RESIZE_NWSE:
				LimeMouse.cursor = RESIZE_NWSE;
			case MouseCursor.__RESIZE_WE:
				LimeMouse.cursor = RESIZE_WE;
			case MouseCursor.__WAIT:
				LimeMouse.cursor = WAIT;
			case MouseCursor.__WAIT_ARROW:
				LimeMouse.cursor = WAIT_ARROW;
			default:
		}
