...
class BlendMode {
	...
	// public static var NOPREMULT_NORMAL(default,never) = new BlendMode(GL.FUNC_ADD, GL.ONE, GL.ONE_MINUS_SRC_ALPHA);
	// public static var NOPREMULT_ADD(default,never) = new BlendMode(GL.FUNC_ADD, GL.ONE, GL.ONE);
	// public static var NOPREMULT_MULTIPLY(default,never) = new BlendMode(GL.FUNC_ADD, GL.DST_COLOR, GL.ONE_MINUS_SRC_ALPHA);
	// public static var NOPREMULT_SCREEN(default,never) = new BlendMode(GL.FUNC_ADD, GL.ONE, GL.ONE_MINUS_SRC_COLOR);
