...
class SamplerState {
	...
	public function new(minFilter:Int, magFilter:Int, wrapModeS:Int, wrapModeT:Int, lodBias:Float = 0.0, maxAniso:Float = 0.0, ignoreSampler:Bool = false,
			centroid:Bool = false, mipmapGenerated:Bool = false) {
	...
	public function equals(other:SamplerState):Bool {
		...
		return (minFilter == other.minFilter
			...
			&& mipmapGenerated == other.mipmapGenerated);
	}
